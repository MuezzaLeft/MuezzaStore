...
<h1>Tambah Produk</h1> 
        ...
        <div class="card mt-4"> 
            <form action="{{ route('flash.toko') }}" class="needs-validation" novalidate="" enctype="multipart/form-data" method="POST"> 
                @csrf 
                <div class="card-body"> 
                    <div class="row"> 
                        <div class="col-6"> 
                        ...
                        <div class="col-6"> 
                            <div class="form-group"> 
                                <label for="priceOriginal">Harga Produk (Point)</label> 
                                <input id="priceOriginal" type="number" class="form-control" name="priceOriginal" required=""> 
                                <div class="invalid-feedback"> 
                                    Kolom ini harus di isi! 
                                </div> 
                            </div> 
                        ...
                        <div class="col-6"> 
                            <div class="form-group"> 
                                ...
                                <input id="priceDiskon" type="number" class="form-control" name="priceDiskon" required=""> 
                                <div class="invalid-feedback"> 
                                    Kolom ini harus di isi! 
                                </div> 
                            </div> 
